using BepInEx;
using DesCloItems.Artifact;
using DesCloItems.Equipment;
using DesCloItems.Equipment.EliteEquipment;
using DesCloItems.Items;
using R2API;
using R2API.Utils;
using System;
...
namespace DesCloItems
{
    ...
    {
        public const string ModGuid = "com.DestroyedClone.DesCloItems";
        public const string ModName = "DesCloItems";
        ...
        private void Awake()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("DesCloItems.my_assetbundlefile"))
            {
